...
void main() {
    ...
    // Enhanced noise with time (slower, subtle speed factors)
    float noise = snoise(uv * 1.5 + vec2(uTime * 0.08, uTime * 0.05)) * 0.25;
...
const GradientPlane = ({
    ...
    useFrame((state) => {
        ...
        // Update both memory uniforms and GPU uniforms directly
