    ...
    <SmoothScroll>
      ...
      <nav className={styles.navBar}>
        ...
        <div className={styles.navLinks}>
          <a href="#features" className={`${styles.navLink} font-tech`}>Features</a>
          <a href="#use-cases" className={`${styles.navLink} font-tech`}>Use Cases</a>
          <a href="#" className={`${styles.navLink} font-tech`}>Docs</a>
          <a href="#" className={`${styles.navLink} font-tech`}>Resources</a>
        </div>
        <div className={styles.navRight} style={{ display: 'flex', gap: '1.5rem', alignItems: 'center' }}>
          <a href={`${clientUrl}/login`} className={`${styles.navLink} font-tech`} style={{ textDecoration: 'none' }}>Login</a>
          <a href={`${clientUrl}/signup`} className={`${styles.primaryBtn} font-tech`} style={{ padding: '0.4rem 1rem', fontSize: '0.875rem', borderRadius: '4px', textDecoration: 'none' }}>Sign Up</a>
        </div>
      </nav>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.heroSection}>
          ...
          <div className={styles.heroActions}>
            <a href={`${clientUrl}/dashboard`} className={`${styles.primaryBtn} font-tech`}>Start a Session</a>
        ...
        <section id="community" className={styles.ctaSection}>
          <div className={styles.ctaBox}>
            ...
            <div className={styles.ctaActions}>
              <a href={`${clientUrl}/workspace`} className={styles.ctaBtn}>Join the Circle</a>
